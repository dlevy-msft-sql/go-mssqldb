...
// TestNullCivilTypesInsertAndRead verifies that NullDate, NullDateTime, and NullTime
// correctly handle NULL and non-NULL values when used as parameters and scan destinations
// against real SQL Server DATE, DATETIME2, and TIME columns.
...
// TestNullCivilTypesQueryRow verifies single-row query with NULL civil types
// using QueryRow (common usage pattern).
...
// TestNullCivilTypesTVP verifies that NullDate, NullDateTime, and NullTime
// work correctly as TVP columns, including null values.
...
// TestNullCivilTypesOutputParam verifies that NullDate, NullDateTime, and NullTime
// work correctly as stored procedure output parameters.
